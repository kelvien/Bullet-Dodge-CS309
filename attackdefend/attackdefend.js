...
//when user clicked join, find game
 eurecaServer.exports.findGame = function() {
       ...
       var conn = this.connection;
        ...
        //if there is a room
            ...
            for(var roomid in rooms) {
                ...
                if(game_instance.player_count < 2 && !game_instance.priv) {
    ...
    eurecaServer.exports.findPrivateGame = function(token) {
       console.log('executed');  
       console.log('private');
       var conn = this.connection;
        ...
        //if there is a room
            ...
            for(var roomid in rooms) {
                ...
                var game_instance = rooms[roomid];
                    ...
                    //If the game is a player short
                if(game_instance.player_count < 2 && game_instance.priv && token == game_instance.tok) {
            ...
            if(!joined_a_game) {
                ...
                createPrivateGame(currentuser, token);
...
function createPrivateGame(player, token)
{
    var remote = clients[player].remote;
    console.log('player ' + player + ' created a private game');
            //Create a new game instance
        var thegame = {
                ...
                player_count:1,
                priv:true,
                tok:token            //for simple checking of state
            };
