...
function preload () {
    ...
    game.load.image('bullet', 'attackdefend/assets/bullet.png');
    game.load.image('earth', 'attackdefend/assets/scorched_earth.png');
    game.load.image('star', 'attackdefend/assets/golden_star.png');
...
function create () {
    ...
    //creates turret
    turret1 = game.add.sprite(10,0,'tank','turret');
    turret2 = game.add.sprite(390,0,'tank','turret');
    turret3 = game.add.sprite(790,10,'tank','turret');
    turret4 = game.add.sprite(790,290,'tank','turret');
    turret5 = game.add.sprite(790,590,'tank','turret');
    turret6 = game.add.sprite(390,590,'tank','turret');
    turret7 = game.add.sprite(10,590,'tank','turret');
    turret8 = game.add.sprite(10,290,'tank','turret');
...
function fire (turret) {
    ...
    if (game.time.now > nextFire && bullets.countDead() > 0)
    {
        ...
        //tells server that opponent can see bullet
         eurecaServer.handleBullet(tx, ty, po.x, po.y, currentroom);
    }
